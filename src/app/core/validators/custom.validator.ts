...
export class CustomValidator {
  ...
  public static uniqueTimeValidator(firstField: string, secondField: string) {
    console.log(firstField, secondField);
    return (c: FormGroup) => {
      // tslint:disable-next-line
      return (c.controls && c.controls[firstField].value == c.controls[secondField].value) ? null : {'uniqueTime': true};
    };
  }
